...
public class FillContactFormTest extends BaseTest {
    ...
    public void fillFirstFormWithValidData()  {
      ArrayList<String> listOfString = new HomePage(driver).openContactPage()
    ...
    public void fillFirstFormWithInvalidData() {
        List<String> errors = new HomePage(driver).openContactPage()
                .fillFirstForm("a", "testgmail.com", "Gg")
                .handleFirstForm().getErrors();
